...
export default class BoxSmallComponent extends Component{
    getRandomImage (){
        const images = [
            ...
            >
                <View style={{padding : 10}}>
                    <Image source={{uri: this.props.items.image}}
                        ...
                        <View style={{padding : 6, marginTop : 50}}>
                            <Text style={styles.supportText4Place}>{this.props.items.title.toUpperCase()}</Text>
                            <Text style={styles.supportText4}>.</Text>
                        </View>
                    </Image>
                </View>
            </TouchableHighlight>

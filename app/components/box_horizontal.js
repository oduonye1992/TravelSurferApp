...
import { View, Image, Text, StyleSheet, Animated, TouchableHighlight } from 'react-native';
import {Actions} from 'react-native-router-flux';
export default class BoxHorizontalComponent extends Component{
    getRandomImage (){
        const images = [
        ...
        return (
            ...
            >
                <View style={{padding : 10}}>
                    ...
                    <Text style={styles.supportText2}>{this.capitalize(this.props.items.title)}</Text>
                </View>
                </TouchableHighlight>
        );
    }
